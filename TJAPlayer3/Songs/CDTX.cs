...
namespace TJAPlayer3
{
    internal class CDTX : CActivity
    {
        ...
        public class CChip : IComparable<CDTX.CChip>, ICloneable
        {
            ...
            public double db実数値;
            public double dbBPM;
            public float fNow_Measure_s = 4.0f;//強制分岐のために追加
            public float fNow_Measure_m = 4.0f;//強制分岐のために追加
            public bool IsEndedBranching = false;//分岐が終わった時の連打譜面が非可視化になってしまうためフラグを追加
            public double dbSCROLL;
